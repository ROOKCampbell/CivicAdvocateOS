...
def purge_nodes():
    # Only the 12 strictly verified nodes remain
    verified_lineage = [
    ...
    with open("reconciliation_manifest.json", "w") as f:
        json.dump({"protected_lineage_vectors": verified_lineage}, f, indent=2)
    print("[✓] REGISTRY PURGED. UNVERIFIED COLLATERAL NODES REMOVED.")
